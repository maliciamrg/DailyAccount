...
public class NotesDbAdapter {
	...
	public static final String KEY_HorsBudget = "HorsBudget";
     ...
     */
    public long createNote(String date, String payee , String amount , String memo , int horsBudget) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_DATE, date);
        initialValues.put(KEY_PAYEE, payee);
        initialValues.put(KEY_AMOUNT, amount);
        initialValues.put(KEY_MEMO, memo);
        initialValues.put(KEY_HorsBudget, horsBudget);
    ...
    public Cursor fetchAllNotes() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_DATE,
        		KEY_PAYEE , KEY_AMOUNT ,  KEY_MEMO , KEY_HorsBudget}, null, null, null, null, KEY_DATE + " Desc" );
    }

    public Cursor fetchAllPayee() {

        return mDb.query(DATABASE_TABLE, new String[] { KEY_PAYEE }, null, null, KEY_PAYEE, null, null );
    }

    public Cursor SumAmount( String dateinf  ) {

        return mDb.query(DATABASE_TABLE, new String[] { KEY_AMOUNT, KEY_DATE , KEY_HorsBudget }, KEY_DATE + ">'" + dateinf + "'" , null, null, null, KEY_DATE + " Asc"  );
    }
    
    public Cursor SumAmountZero( String dateinf  ) {

        return mDb.query(DATABASE_TABLE, new String[] { KEY_AMOUNT, KEY_DATE }, KEY_DATE + ">'" + dateinf + "' and HorsBudget = 0 " , null, null, null, KEY_DATE + " Asc"  );
    }
    
    public Cursor SumAmountHorsCptZero( String dateinf  ) {

        return mDb.query(DATABASE_TABLE, new String[] { KEY_AMOUNT, KEY_DATE }, KEY_DATE + ">'" + dateinf + "' and HorsBudget not = 0 " , null, null, null, KEY_DATE + " Asc"  );
    }
    ...
    public Cursor fetchNote(long rowId) throws SQLException {
        ...
        Cursor mCursor =
            ...
            mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
            		KEY_DATE, KEY_PAYEE , KEY_AMOUNT , KEY_MEMO , KEY_HorsBudget }, KEY_ROWID + "=" + rowId, null,
                    null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
     ...
     */
    public boolean updateNote(long rowId, String date, String payee , String amount , String memo , int horsBudget) {
        ContentValues args = new ContentValues();
        args.put(KEY_DATE, date);
        args.put(KEY_PAYEE, payee);
        args.put(KEY_AMOUNT, amount);
        args.put(KEY_MEMO, memo);
        args.put(KEY_HorsBudget, horsBudget);
    ...
    public Cursor fetchAllParam() {
        return mDb.query(DATABASE_TABLE_2, new String[] {KEY_ROWID, KEY_coParam,
        		KEY_tyParam , KEY_vaParam }, null, null, null, null , null );
    }

    public boolean updateParam( String coParam , String tyParam , String vaParam) {
        ContentValues args = new ContentValues();
        args.put(KEY_coParam, coParam);
        args.put(KEY_tyParam, tyParam);
        args.put(KEY_vaParam, vaParam);
        return mDb.update(DATABASE_TABLE_2, args, KEY_coParam + "='" + coParam + "'", null) > 0;
    }

    public Cursor selectParam(String coParam) {
        return mDb.query(DATABASE_TABLE_2, new String[] {KEY_ROWID, KEY_coParam,
        		KEY_tyParam , KEY_vaParam }, KEY_coParam + "='" + coParam + "'" , null, null, null , null );
    }
    
    public long insertParam( String coParam , String tyParam , String vaParam) {
        ContentValues initialValues = new ContentValues();
